        ...
        <div class="row justify-content-center">
            <div class="bs-component" style="width: 100%">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#car_brand">{{trans('label.car.brand')}}</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#catalog_car">{{trans('label.car.catalog')}}</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#car">{{trans('label.car.grade')}}</a></li>
                </ul>
