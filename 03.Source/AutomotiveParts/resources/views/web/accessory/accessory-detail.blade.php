                ...
                <div class="row">
                    <div class="col-lg-5 col-md-6 col-xs-6">
                        <div class="image" id="lightgallery">
                            <a href="{{asset($accessary[0]->photo_top)}}" title="{{$accessary[0]->photo_top_name}}">
                                <img src="{{asset($accessary[0]->photo_top)}}" alt="{{$accessary[0]->photo_top_name}}"
                            ...
                            <a href="{{asset($accessary[0]->photo_bottom)}}"
                               title="{{$accessary[0]->photo_bottom_name}}">
                                <img width="65px" src="{{asset($accessary[0]->photo_bottom)}}"
                                     alt="Suzuki 083161008B NUT" class="img-ui thumbnail img-responsive -ezoom-part">
                            </a>
                    ...
                    <div class="text-center col-lg-4 col-md-12 col-xs-12">
                        <div class="caption">
                            ...
                            <div class="price">
                                <div class="sr-price"><span class="price-new">{{ $accessary[0]->retail_price_min ? number_format($accessary[0]->retail_price_min) : 'N/A' }}
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    @foreach($accessary[0]->accessaryLinks as $key => $sub)
                                        <tr>
                                            <td>
                                                @if($sub[0]->type !== null and $sub[0]->type === 0) {{trans('label.accessary.oem')}}
                                                @elseif($sub[0]->type !== null and $sub[0]->type === 1) {{trans('label.accessary.options')}}
                                                @else{{trans('label.accessary.genuine')}}
                                                @endif
                                            </td>
                                            <td>
                                                {{ $sub[0]->code ? $sub[0]->code : 'N/A' }}
                                            </td>
                                            <td>
                                                {{ $sub[0]->name_vi ? $sub[0]->name_vi : 'N/A' }}
                                            </td>
                                            <td>
                                                {{ $sub[0]->nation_name ? $sub[0]->nation_name : 'N/A' }}
                                            </td>
                                            <td class="text-right">
                                                {{ $sub[0]->retail_price_min ? number_format($sub[0]->retail_price_min) : 'N/A' }} đ
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
